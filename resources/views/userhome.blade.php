    ...
    <div class="navigation">
        ...
        <ul>
            ...
            <li class="list">
                ...
                <b></b>
                <a href="#">
                    <span class="icon-setting"><ion-icon name="settings-outline"></ion-icon></span>
                    <span class="icon-box"><ion-icon name="cube-outline"></ion-icon></span>
                    <span class="title_2">แจ้งซ่อม/แจ้งเบิก</span>
                </a>
            </li>
